        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 items-center">
          ...
          <div className="lg:col-span-3" data-aos="fade-left">
            ...
            <p className="text-primary font-semibold text-lg mb-6">
              Founder & CEO, Mit Innovative
            </p>

            <p className="text-muted-foreground text-lg leading-relaxed mb-6">
              A passionate video production expert with over 8 years of
              experience in creating compelling visual content. Amit founded Mit
              Innovative with a vision to help businesses tell their stories
              through powerful video marketing and digital advertising.
            </p>

            <p className="text-muted-foreground leading-relaxed mb-8">
              Under his leadership, Mit Innovative has delivered 5600+ successful
              projects for clients across diverse industries. His expertise
              spans professional video editing, brand promotion, social media
              marketing, and cutting-edge AI-generated content.
            </p>
