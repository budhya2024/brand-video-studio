...
const Footer = () => {
  ...
  return (
    <footer className="relative pt-20 pb-8 border-t border-border bg-gradient-to-b from-background to-card/50">
      {/* Background Effects */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="lg:col-span-1">
            <a href="/" className="inline-block mb-6">
             <span className="font-display text-2xl font-bold"><span className="text-foreground">Mit</span> <span className="gradient-text">Innovative</span></span>
            </a>
